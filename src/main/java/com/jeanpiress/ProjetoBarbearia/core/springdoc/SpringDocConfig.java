...
public class SpringDocConfig {
    ...
    private Map<String, ApiResponse> gerarResponses() {
       final Map<String, ApiResponse> apiResponseMap = new HashMap<>();
        ...
        apiResponseMap.put(badRequestResponse, new ApiResponse().description("Requisição invalida"));
        ...
        apiResponseMap.put(internalServerError, new ApiResponse().description("Erro interno do servidor"));
