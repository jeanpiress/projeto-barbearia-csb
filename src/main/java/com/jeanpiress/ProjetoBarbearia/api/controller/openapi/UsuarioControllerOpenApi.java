...
public interface UsuarioControllerOpenApi {
    ...
    @Operation(summary = "Busca um usuario por id", responses ={
            ...
            @ApiResponse(responseCode = "400", description = "Id do usuario inválido", content = @Content(schema = @Schema)),
    ...
    {
            @ApiResponse(responseCode = "400", description = "email do usuario inválido", content = @Content(schema = @Schema)),
            @ApiResponse(responseCode = "404", description = "Usuario não encontrado", content = @Content(schema = @Schema))
    })
    ...
    @Operation(summary = "Cria um novo usuario com cliente existente", responses =
    {
            ...
            @ApiResponse(responseCode = "400", description = "Mensagem incompreensivel", content = @Content(schema = @Schema)),
